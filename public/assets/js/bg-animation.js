(function () {
	// var canvas = document.getElementById('bg_animation'),
	...
	var space = new CanvasSpace( "bg_animation", colors.b2 ).display();
	...
	Dust.prototype.animate = function(time, fps, context) {
	  ...
	  gray = Math.max(0, Math.min( 0.3, (Math.random() > 0.2) ? gray + 0.05 : gray - 0.05 ) );
